...
Choose the route that matches what you need. Public reports are visible to
everyone, so remove note contents, workspace paths, API keys, cookies, and
...
first and reduce the report to the smallest workspace or file that still shows
the problem.
...
The issue tracker cannot provide general Electron, Markdown, Git, shell, or
third-party service support; recover credentials or data from services Neuron
does not control; accept private workspace archives as a substitute for a
minimal reproduction; or promise implementation dates. Questions about
contributing belong in the [contribution guide](CONTRIBUTING.md). Security
reports belong only in the private channel above.
